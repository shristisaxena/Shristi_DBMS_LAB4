...
-- Query 7 
select product.PRO_ID,product.PRO_NAME from product join supplier_pricing on product.PRO_ID=supplier_pricing.PRO_ID join `order` on `order`.PRICING_ID=supplier_pricing.PRICING_ID where ORD_DATE > '2021-10-05';
